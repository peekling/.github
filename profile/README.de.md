![Peekling-Figuren versammelt in einer hellen, einladenden Landschaft](https://cdn.peekling.com/v1/community/peekling-community-banner.png)

# Machen wir das Web lebendiger ✨

Peeklings sind kleine animierte Figuren, die sich leise und verspielt zu einer Website gesellen können, ohne im Weg zu sein. Lerne sie kennen, stell dir deinen eigenen Peekling vor oder hilf uns dabei, das Kommende zu gestalten.

## Was ist ein Peekling?

Ein Peekling ist ein kleiner animierter Begleiter mit eigenem Aussehen, eigener Persönlichkeit und einer eigenen Art, auf die umgebende Seite zu reagieren. Er lebt neben einer Website und bringt etwas Leben hinein, während die Seite ganz sie selbst bleiben kann.
...
- **Lernende und Menschen, die zum ersten Mal etwas gestalten**, können in Portfolios oder Nebenprojekten experimentieren.
...
- **Menschen, die sich einfach über einen kleinen Begleiter in der Nähe freuen**, gehören genauso zu diesem Bild.
...
- **Verbessere eine offizielle Figur** in [peekling-characters](https://github.com/peekling/peekling-characters).
- **Teile eine von der Community erstellte Figur** in [awesome-peeklings](https://github.com/peekling/awesome-peeklings).
...
| [awesome-peeklings](https://github.com/peekling/awesome-peeklings) | Die kuratierte Sammlung von Figuren aus der Community. Jeder Beitrag enthält ein vollständiges, rein datenbasiertes Pack mit Lizenz und Rechteangaben. |
...
<p align="center">
  <img src="https://cdn.peekling.com/v1/brand/peek-wave-wink-v1.gif" alt="Peek, der erste Peekling, winkt, zwinkert und lächelt" width="200">
</p>

Peek ist der erste Peekling. Neugierig und fröhlich folgt Peek Mauszeigern und feiert kleine Erfolge.

Ein Peekling ist eine kleine Figur, die leise und verspielt rund um eine Website leben kann, ohne im Weg zu sein.

Du kannst deinen eigenen Peekling erstellen, mit der Community teilen und zu deiner Website hinzufügen. [Beginne mit der Anleitung für Community-Packs](https://github.com/peekling/awesome-peeklings/blob/main/CONTRIBUTING.md).

## Gemeinsam wachsen

Peekling wächst mit jedem einzelnen öffentlich verfügbaren Baustein. Wenn weitere Bausteine hinzukommen, soll sich die Reise natürlich anfühlen: eine Figur kennenlernen, sie entdecken, ausprobieren, zu einer Website hinzufügen, zur eigenen machen und das Gelernte mit der Community teilen.
...
![Ein schmaler Streifen aus Gras, Wildblumen und Blättern mit einem gewundenen Pfad](https://cdn.peekling.com/v1/community/peekling-ground-footer-v1.png)
