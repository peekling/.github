![Peekling-personages samen in een helder, uitnodigend landschap](https://cdn.peekling.com/v1/community/peekling-community-banner.png)

# Laten we het web levendiger maken ✨

Peeklings zijn kleine geanimeerde personages die zich rustig en speels bij een website kunnen voegen, zonder in de weg te zitten. Kom kennismaken, bedenk je eigen Peekling of help ons bouwen aan wat hierna komt.

## Wat is een Peekling?

Een Peekling is een klein geanimeerd gezelschap met een eigen uiterlijk, persoonlijkheid en manier van reageren op de pagina eromheen. Het leeft naast een website en brengt die een beetje tot leven, terwijl de pagina zichzelf kan blijven.
...
Studenten en beginnende makers kunnen experimenteren. Kunstenaars en schrijvers kunnen nieuwe persoonlijkheden bedenken. Ontwikkelaars kunnen interacties tot leven brengen. Bedrijven kunnen digitale omgevingen menselijker helpen maken. Ook mensen die het gewoon fijn vinden om een klein gezelschap in de buurt te hebben, horen er helemaal bij.
...
<p align="center">
  <img src="https://cdn.peekling.com/v1/brand/peek-wave-wink-v1.gif" alt="Peek, de eerste Peekling, die zwaait, knipoogt en glimlacht" width="200">
</p>

Peek is de eerste Peekling. Nieuwsgierig en vrolijk volgt Peek aanwijzers en viert kleine successen.
...
Peekling groeit met één openbaar onderdeel tegelijk. Naarmate er meer onderdelen beschikbaar komen, willen we dat de reis natuurlijk aanvoelt: ontmoet een personage, leer het kennen, probeer het uit, voeg het aan een website toe, maak het eigen en deel wat je leert met de community.
...
![Een smalle strook gras, wilde bloemen, bladeren en een kronkelend pad](https://cdn.peekling.com/v1/community/peekling-ground-footer-v1.png)
