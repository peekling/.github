![Les personnages Peekling réunis dans un paysage lumineux et accueillant](https://cdn.peekling.com/v1/community/peekling-community-banner.png)

# Rendons le web plus vivant ✨

Les Peeklings sont de petits personnages animés qui peuvent rejoindre un site web avec discrétion et malice, sans jamais gêner. Venez les rencontrer, imaginez le vôtre ou aidez-nous à construire la suite.

## Qu’est-ce qu’un Peekling ?

Un Peekling est un petit compagnon animé avec son apparence, sa personnalité et sa façon de réagir à la page qui l’entoure. Il vit aux côtés d’un site web et lui apporte un peu de vie tout en le laissant rester lui-même.
...
Les élèves, les étudiants et les personnes qui créent pour la première fois peuvent expérimenter. Les artistes et les auteurs peuvent imaginer de nouvelles personnalités. Les développeurs peuvent donner vie aux interactions. Les entreprises peuvent contribuer à rendre les espaces numériques plus humains. Les personnes qui apprécient simplement la présence d’un petit compagnon font tout autant partie de l’aventure.
...
- **Améliorez un personnage officiel** dans [peekling-characters](https://github.com/peekling/peekling-characters).
- **Partagez un personnage créé par la communauté** dans [awesome-peeklings](https://github.com/peekling/awesome-peeklings).
...
| [awesome-peeklings](https://github.com/peekling/awesome-peeklings) | La collection sélectionnée de personnages créés par la communauté. Chaque contribution comprend un Pack complet composé uniquement de données, avec sa licence et son relevé de droits. |
...
<p align="center">
  <img src="https://cdn.peekling.com/v1/brand/peek-wave-wink-v1.gif" alt="Peek, le premier Peekling, qui salue, fait un clin d’œil et sourit" width="200">
</p>

Peek est le premier Peekling. Curieux et joyeux, Peek suit les pointeurs et célèbre les petites réussites.

Un Peekling est un petit personnage qui peut vivre autour d’un site web avec discrétion et malice, sans jamais gêner.

Vous pouvez créer votre propre Peekling, le partager avec la communauté et l’ajouter à votre site web. [Commencez par le guide des Packs communautaires](https://github.com/peekling/awesome-peeklings/blob/main/CONTRIBUTING.md).

## Grandir ensemble

Peekling grandit en dévoilant un élément public à la fois. À mesure que de nouveaux éléments deviennent disponibles, nous voulons que le parcours reste naturel : rencontrer un personnage, apprendre à le connaître, l’essayer, l’ajouter à un site web, se l’approprier et partager ses découvertes avec la communauté.
...
![Une étroite bande d’herbe, de fleurs sauvages et de feuillage traversée par un chemin sinueux](https://cdn.peekling.com/v1/community/peekling-ground-footer-v1.png)
